...
def test_prob_complete_scores_on_AF_ex(af_ex_framework):
    """
    Tests the final probabilistic scores on the AF_ex framework.
    """
    prob = ProbComplete(af_ex_framework, p=0.5)
    scores = prob.get_scores()

    # TODO: Replace with the canonical scores generated by your implementation.
    expected_scores = {
        '1': 0.495,
        '2': 0.2554,
        '3': 0.1885,
